                    ...
                    <!-- Col-lg-10 -->
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 text-justify">  
                                ...
                                <p>
                                    Para poder procesar la transacción con el formulario de ejemplo, debe modificar el archivo "AuthorizationShipBill.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\API\01 - Pagos con tarjeta\01 - Authorization".
                                </p>
