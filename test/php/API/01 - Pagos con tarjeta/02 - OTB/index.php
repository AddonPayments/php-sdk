                    ...
                    <div class="col-lg-10" >
                            ...
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                ...
                                <div class="p-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="comments">// Imports necesarios para realizar una operación OTB</span>
                                        <br>
                                        ...
                                        <br>
                                            <span class="pl-4">$</span><span class="variables">response</span> <span class="require">=</span> $<span class="variables">card</span><span class="require">-></span><span class="configure">verify</span><span class="require">()</span>
                                        <br>
                            ...
                            <div class="pl-3 pt-3 pr-3 text-justify">
                                ...
                                <h5 id="ConfigTarjeta" class="mt-3">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Indicamos cuál es el número de la tarjeta que deseamos verificar:
                                    ...
                                    <div class="p-4 mb-4 panelCode">
                                        <code>
                                            ...
                                            <br>
                                                <span class="pl-3">$</span><span class="variables">card</span><span class="require">-></span><span class="variables">cvnPresenceIndicator</span> <span class="require">=</span> <span class="service">CvnPresenceIndicator</span><span class="require">::</span><span class="variables">PRESENT</span><span class="require">;</span> <span class="comments">// Función que indica que el cliente está presente a la hora de realizar el cargo (PRESENT)</span>
                                            <br>
                                    ...
                                    <ul>
                                        <li>
                                            Llamamos al objeto "$card" y ejecutamos la función de verificación "verify()": 
                                            <span class="arrow">$</span><span class="variableBgW">card</span>
                                            <span class="arrow">->verify()</span>
                                        </li>
                                        <li>
                                            Por último, ejecutamos la petición de envío para comprobar la validez de la tarjeta:
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 text-justify">
                                ...
                                <p>
                                    Para poder procesar la transacción con el formulario de ejemplo, debe modificar el archivo "otb.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\API\01 - Pagos con tarjeta\02 - OTB".
                                </p>
                                ...
                                <form id="formulario_envio" method="POST" autocomplete="off" class="pt-2 col-lg-12" action="otb.php">
