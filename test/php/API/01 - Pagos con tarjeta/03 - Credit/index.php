...
<html>
    <head>
        ...
        <title>Credit (API) - SDK PHP</title>
                ...
                <ul class="navbar-nav ml-auto pl-2 pr-2">
                    ...
                    <li class="nav-item ml-1 dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <hr class="m-0 p-0">
                                <a class="dropdown-item pl-2" href="../01%20-%20Autorización/index.php">Autorización</a>
                                <a class="dropdown-item pl-2" href="../01%20-%20Autorización/DatosDelCliente.php">Datos adicionales</a>
                    ...
                    <div class="col-lg-2 sticky-top d-none d-sm-none d-lg-block d-xl-block MenuLateral">
                        ...
                        <nav class="navbar sticky-top navbar-light" style="padding: 0px;">
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link" href="#credit">1. Credit</a>
                                <nav class="nav nav-pills flex-column">
                                ...
                                <nav class="nav nav-pills flex-column">
                                    ...
                                    <a class="nav-link ml-3 my-1" id="#ConfigTarjeta" href="#ConfigTarjeta">2.2 Datos de la tarjeta</a>
                    ...
                    <div class="col-lg-10" >
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                ...
                                <p>
                                   Este tipo de solicitud le permite ingresar un importe a la tarjeta de un cliente. Para procesar esta solicitud, debe configurar la contraseña de <b>Refund</b> que puede establecer con un miembro de nuestro equipo de soporte Addon Payments. Esta contraseña debe cifrarse utilizando el algoritmo SHA-1 antes de agregarse a la solicitud.
                                </p>

                                <p class="alert alert-primary">
                                    <small>
                                       --> Las solicitudes de crédito no se envían al Emisor, se colocan directamente en el archivo de liquidación del día siguiente. Puede contactar con nosotros llamando al teléfono <a target="_blank" href="tel:914353028">914 353 028 opción 2</a> o enviándonos un email a <a target="_blank" href="mailto:soporte@addonpayments.com">soporte@addonpayments.com.</a>
                                    </small>
                                </p>
                                ...
                                <div class="p-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="comments">// Imports necesarios para realizar un ingreso</span>
                                        <br>
                                        ...
                                        <br>
                                            <span class="pl-4">$</span><span class="variables">response</span> <span class="require">=</span> $<span class="variables">card</span><span class="require">-></span><span class="configure">refund</span><span class="require">(</span><span class="variables">20</span><span class="require">)</span>
                                        <br>
                            ...
                            <div class="pl-3 pt-3 pr-3 text-justify">
                                ...
                                <h5 id="ConfigTerminal" class="mt-3">
                                    ...
                                    <ul>
                                       ...
                                       <li>
                                           SubAccount = Subcuenta faciltiada en la llamada de Subcuenta faciltiada en la llamada de cualificación (si se deja en blanco se envía la subcuenta por defecto que le hayan creado).
                                       </li>
                                       <li>
                                           Shared_Secret = Contraseña de seguridad del terminal.
                                       </li>
                                       <li>
                                           Refund_Password = Contraseña de Refund.
                                       </li>
                                    </ul>
                                ...
                                <h5 id="ConfigTarjeta" class="mt-3">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Indicamos cuál es el número de la tarjeta a la cual vamos a realizar el ingreso:
                                ...
                                <ul>
                                    <li>
                                        Llamamos al objeto "$card" y ejecutamos la función de reembolso indicando el importe que queremos ingresar "refund(20)": 
                                        <span class="arrow">$</span><span class="variableBgW">card</span>
                                        <span class="arrow">->refund(</span><span class="variableBgW">20</span><span class="arrow">)</span>
                                    </li>
                                    <li>
                                        Posteriormente debemos indicar la moneda en la que vamos a realizar el ingreso:
                                        <span class="arrow">->withCurrency(</span><span class="comentariosBgW">"EUR"</span><span class="arrow">)</span>
                                    </li>
                                    <li>
                                        Por último, ejecutamos la petición de reembolso hacia la tarjeta que hemos indicado anteriormente:
                                ...
                                <div class="p-4 mb-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="pl-3 new">try</span><span class="require"> {</span>
                                        <br>
                                            <span class="pl-4 ">$</span><span class="variables">response</span> <span class="require">=</span> $<span class="variables">card</span><span class="require">-></span><span class="configure">refund</span><span class="require">(<span class="variables">20</span><span class="require">)</span>
                                        <br>
                                            <span class="pl-5 require">-></span><span class="configure">withCurrency</span><span class="require">("</span><span class="green">EUR</span><span class="require">")</span>
                                        <br>
                                            <span class="pl-5 require">-></span><span class="configure">execute</span><span class="require">();</span> <span class="comments">// Ejecutamos la operación</span>
                                        <br>
                                        <br>
                                            <span class="comments pl-4">// Obtenemos la respuesta y la mostramos</span>
                                        <br>
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 text-justify">
                                ...
                                <p>
                                    Para poder procesar un ingreso con el formulario de ejemplo, debe modificar el archivo "Credit.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\API\01 - Pagos con tarjeta\03 - Credit".
                                </p>
                                ...
                                <p>
                                    El siguiente formulario le permite enviar un ingreso contra el entorno de pruebas de Addon Payments introduciendo los datos adicionales del usuario.
                                </p>
                                <!-- Ejemplo de formulario -->
                                <form id="formulario_envio" method="POST" autocomplete="off" class="pt-2 col-lg-12" action="Credit.php">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 mt-2 mb-2 formulario">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <button type="submit" class="btn btn-block btn-primary" onclick="validate();">Realizar ingreso</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
