<?php
  ...
  // Creamos el objeto "CreditCardData" y asociamos los nuevos datos
  $newCardDetails = new CreditCardData();
  $newCardDetails->number = $numeroTarjeta;
  $newCardDetails->expMonth = $fechaMM;
  $newCardDetails->expYear = $fechaYY;
  $newCardDetails->cardHolderName = $nombre;

  // Añadimos los nuevos detalles de tarjeta al método de pago
  $paymentMethod->paymentMethod = $newCardDetails;

  try {
    // Actualizamos los detalles de la tarjeta
