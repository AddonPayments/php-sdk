...
<html>
    <head>
        ...
        <title>Autenticación con Token (API) - SDK PHP</title>
                    ...
                    <div class="col-lg-2 sticky-top d-none d-sm-none d-lg-block d-xl-block MenuLateral">
                        ...
                        <nav class="navbar sticky-top navbar-light" style="padding: 0px;">
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link" href="#authCard">1. Autorización con tarjeta almacenada</a>
                                <nav class="nav nav-pills flex-column">
                                ...
                                <nav class="nav nav-pills flex-column">
                                    ...
                                    <a class="nav-link ml-3 my-1" id="#envioOP" href="#envioOP">2.3 Envío de la petición de cobro</a>
                                </nav>
                    ...
                    <div class="col-lg-10" >
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                <h3 id="authCard" class="titulo">
                                    1. Autorización con tarjeta almacenada
                                </h3>
                                <hr>

                                <p>
                                    Una vez que tenga la tarjeta almacenada, puede enviar fácilmente una autorización contra ella. En lugar de los datos recopilados de la tarjeta, simplemente envía el token del cliente (Pagador) y la referencia de la tarjeta (Método de pago), Addon Payments obtiene los datos de la tarjeta almacenados de forma segura de nuestros servidore y crea una autorización que luego enviamos al Emisor.

                                    Según las normas de cumplimiento de PCI, el código de seguridad (CVN, CVV) no se puede almacenar. Sin embargo, si en su aplicación o sitio web le brinda al cliente la opción de usar una tarjeta almacenada, puede solicitarle nuevamente su código de seguridad e incluirlo en la solicitud.
                                </p>
                                ...
                                <div class="p-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="pl-3">$</span><span class="variables">paymentId</span> <span class="require">= "</span><span class="green">ee7c4530-8a2c-4dad-be80-65078cd29535</span><span class="require">";</span>
                                        <br>
                                        <br>
                                        ...
                                        <br>
                                            <span class="pl-4">$</span><span class="variables">response</span> <span class="require">=</span> $<span class="variables">paymentMethod</span><span class="require">-></span><span class="configure">charge</span><span class="require">(</span><span class="variables">565,00</span><span class="require">)</span>
                                        <br>
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-1 mb-3 text-justify">
                                ...
                                <h5 id="refExist" class="mt-3">
                                    ...
                                    <p>
                                       Necesitamos asociar la referencia del cliente y la referencia de la tarjeta a la cual deseamos realizar el cargo.
                                    </p>
                                ...
                                <h5 id="envioOP" class="mt-3">
                                    2.3 Envío de la petición de cobro
                                </h5>
                                ...
                                <ul>
                                    <li>
                                        Indicamos el importe que queremos cobrar a la tarjeta almacenada:
                                        <ul>
                                            <li>
                                                <span class="arrow">$</span><span class="variableBgW">paymentMethod</span>
                                                <span class="arrow">->charge(</span><span class="variableBgW">565,00</span><span class="arrow">)</span>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        Debemos indicar la moneda con la cual vamos a realizar el cargo en la tarjeta:
                                        <ul>
                                            <li>
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                ...
                                <p>
                                    Para realizar una autorización a una tarjeta tokenizada con el formulario de ejemplo, debe modificar el archivo "auth.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\API\02 - Almacenamiento de tarjeta\05 - Auth".
                                </p>
                                <p>
                                ...
                                <form id="formulario_envio" method="POST" autocomplete="off" class="col-lg-12" action="auth.php">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 mt-2 mb-2 formulario">
                                                    ...
                                                    <div class="form-group">
                                                        <p>
                                                            <b>Importe:</b> 565,00€
                                                            <input type="hidden" name="importe" value="565,00">
                                                        </p>
                                                    </div>
