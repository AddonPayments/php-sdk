...
<html>
    <head>
        ...
        <title>Retener transacción (API) - SDK PHP</title>
                    ...
                    <li class="nav-item ml-1 dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <hr class="m-0 p-0">
                                ...
                                <a class="dropdown-item pl-2 active"  href="#">Retener transacción</a>
                    ...
                    <div class="col-lg-2 sticky-top d-none d-sm-none d-lg-block d-xl-block MenuLateral">
                        ...
                        <nav class="navbar sticky-top navbar-light" style="padding: 0px;">
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link" href="#fraud">1. Retener transacción</a>
                                <nav class="nav nav-pills flex-column">
                    ...
                    <div class="col-lg-10" >
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                <h3 id="fraud" class="titulo">
                                    1. Retener transacción
                                </h3>
                                <hr>

                                <p>
                                   Esta solicitud cambiará el estado de la transacción a "retenida (hold)". Si la transacción fue exitosa se incluirá en el próximo archivo de liquidación, esto evitaría su inclusión hasta el momento en que se libere la transacción. Si está utilizando las preautorizaciones, la transacción debe liberarse y luego capturarse antes de que se incluya en el archivo de liquidación.
                                </p>
                                ...
                                <div class="p-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="pl-4">$</span><span class="variables">response</span> <span class="require">=</span> $<span class="variables">transaction</span><span class="require">-></span><span class="configure">hold</span><span class="require">()</span>
                                        <br>
                                            <span class="pl-5 require">-></span><span class="configure">withReasonCode</span><span class="require">(</span><span class="service">ReasonCode</span><span class="require">::FRAUD)</span>
                                        <br>
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-1 mb-3 text-justify">
                                ...
                                <ul>
                                    ...
                                    <ul>
                                        <li>
                                            <span class="arrow">->withReasonCode($</span><span class="arrow">ReasonCode::FRAUD)</span>
                                        </li>
                                    </ul>
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                ...
                                <p>
                                    Para poder procesar un ingreso con el formulario de ejemplo, debe modificar el archivo "fraud.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\API\03 - Fraud Management\03 - Hold".
                                </p>
                                        ...
                                        <div class="col-lg-4 pl-lg-4">
                                            <div class="row">
                                                <div class="col-lg-12 mt-2 mb-2 formulario">
                                                    ...
                                                    <h4 class="pt-2">Retener operación</h4>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <button type="submit" class="btn btn-block btn-primary">Retener</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
