                ...
                <nav class="navbar sticky-top navbar-light" style="padding: 0px;">
                    <nav class="nav nav-pills flex-column">
                        ...
                        <nav class="nav nav-pills flex-column">
                            ...
                            <a class="nav-link ml-3 my-1" id="#envioOP" href="#envioOP">2.3 Envío de la operación archivo PHP</a>
                            <a class="nav-link ml-3 my-1" id="#envioOPHTML" href="#envioOPHTML">2.4 Envío de la operación archivo HTML</a>
                        </nav>
            ...
            <div class="col-lg-10" >
                ...
                <div class="contenedor">
                  <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                      ...
                      <div class="p-4 panelCode">
                          <code>
                              ...
                              <br>
                                  <span class="pl-4">$</span><span class="variables">hppJson</span> <span class="require">=</span> $<span class="variables">service</span><span class="require">-></span><span class="configure">verify</span><span class="require">()</span>
                              <br>
                  ...
                  <div class="pl-3 pt-3 mb-2 pb-2 pr-3 text-justify">
                    ...
                    <p>
                        Para poder procesar la transacción con el formulario de ejemplo, debe modificar el archivo "otb.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\HPP\01 - Pagos con tarjeta\02 - OTB".
                    </p>
