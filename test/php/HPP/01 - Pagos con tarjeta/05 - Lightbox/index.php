...
<html>
    <head>
        ...
        <title>Lightbox (HPP) - SDK PHP</title>
                    ...
                    <li class="nav-item ml-1 dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <hr class="m-0 p-0">
                                ...
                                <a class="dropdown-item pl-2 active" href="#">Lightbox</a>
                        </div>
                    </li>
                    <li class="nav-item ml-1 dropdown">
                        <a class="nav-link pl-2 dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="col-lg-2 sticky-top d-none d-sm-none d-lg-block d-xl-block MenuLateral">
                        ...
                        <nav class="navbar sticky-top navbar-light" style="padding: 0px;">
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link" href="#lightbox">1. Lightbox</a>
                                <nav>
                            ...
                            <div class="pl-3 pt-3 mb-4 pb-1 pr-3 text-justify">
                                ...
                                <div class="p-4 mb-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="pl-5 ml-3 service">RealexHpp</span><span class="new">.lightbox.init(</span><span class="require">"</span><span class="green">payButtonId</span><span class="require">"</span><span class="new">,</span> <span class="require">"</span><span class="green">response.php</span><span class="require">"</span><span class="new">,</span> <span class="variables">jsonFromRequestEndpoint</span><span class="new">);</span>
                                        <br>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <span class="variableBgW">form</span><span class="arrow">.appendChild(</span><span class="variableBgW">internal</span><span class="arrow">.createFormHiddenInput(</span><span class="require">"</span><span class="variableBgW">HPP_POST_RESPONSE</span><span class="require">"</span><span class="arrow">,  hppOriginParam));</span> 
                                    </li>
                                </ul>
        ...
        <script>
            $(document).ready(function() {
                $.getJSON("request.php", function(jsonFromRequestEndpoint) {
                    ...
                    RealexHpp.lightbox.init("payButtonId", "https://midominio.es/response.php", jsonFromRequestEndpoint);
                });
            });
        </script>
