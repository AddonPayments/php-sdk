...
<html>
    <head>
        ...
        <title>Crear un cliente (HPP) - SDK PHP</title>
    ...
    <body>
                    ...
                    <div class="col-lg-10" >
                            ...
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                ...
                                <div class="p-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                            <span class="pl-3">$</span><span class="variables">config</span><span class="require">-></span><span class="variables">hostedPaymentConfig</span><span class="require">-></span><span class="variables">cardStorageEnabled</span> <span class="require">= "</span><span class="green">1</span><span class="require">";</span>
                                        <br>
                            ...
                            <div class="pl-3 pt-3 pr-3 pb-1 mb-3 text-justify">
                                ...
                                <div class="p-4 mb-4 panelCode">
                                    <code>
                                        ...
                                        <br>
                                        <br>
                                            <span class="pl-3 comments">// Indicamos que queremos enviar una petición de almacenamiento de tarjeta configurando el parámetro a "1"</span>
                                        <br>
                                            <span class="pl-3">$</span><span class="variables">config</span><span class="require">-></span><span class="variables">hostedPaymentConfig</span><span class="require">-></span><span class="variables">cardStorageEnabled</span> <span class="require">= "</span><span class="green">1</span><span class="require">";</span>
                                        <br>
                                ...
                                <h5 id="cardStorage" class="mt-3">
                                    ...
                                    <ul>
                                        ...
                                        <ul>
                                            <li>
                                                <span class="arrow">$hostedPaymentData-></span><span class="variableBgW">customerExists</span><span class="require"> = </span><span class="orangeBgW">false</span><span class="arrow">;</span>
                                            </li>
                                        </ul>
                                    </ul>
                        ...
                        <div class="contenedor">
                            <div class="pl-3 pt-3 pr-3 pb-4 mb-3 text-justify">
                                ...
                                <p>
                                    Para poder procesar un ingreso con el formulario de ejemplo, debe modificar el archivo "CrearCliente.php" que se encuentra en la ruta "vendor\addonpayments\php-sdk\test\php\HPP\02 - Almacenamiento de tarjeta\01 - Crear un cliente".
                                </p>
        ...
        <script>
          $(document).ready(function() {
            $.getJSON("CrearCliente.php", function(jsonFromRequestEndpoint) {
